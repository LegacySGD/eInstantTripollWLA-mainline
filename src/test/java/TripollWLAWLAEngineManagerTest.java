...
public class TripollWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TripollWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TripollWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TripollWLAIW/InitOutcome.xml").getDocumentElement();
